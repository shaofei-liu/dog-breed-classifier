...
└── output/
    └── sample_run_checkpoint.bin  # Model weights (download from HF)
```
...
### Docker Container
Deploy the Dockerfile to any Docker-compatible platform (AWS, Google Cloud, Azure, local server, etc.)

### Local Deployment
Run the Gradio interface or Docker container on your local machine or private server
...
- **Solution**: Download `sample_run_checkpoint.bin` and place in `output/` directory

**Issue**: Image format not supported
- **Solution**: Use JPEG, PNG, or WebP format images

**Issue**: Out of memory errors
- **Solution**: Reduce batch size or use a machine with more RAM/GPU

## License

This project is provided for educational and commercial use. See LICENSE file for details.

## Links

- **Personal Website**: [https://www.shaofeiliu.com](https://www.shaofeiliu.com/)
- **Vision Transformer**: [https://github.com/google-research/vision_transformer](https://github.com/google-research/vision_transformer)
- **Stanford Dogs Dataset**: [http://vision.stanford.edu/aditya/ImageNetDogs/](http://vision.stanford.edu/aditya/ImageNetDogs/)
...
3. Check the model documentation: [https://github.com/google-research/vision_transformer](https://github.com/google-research/vision_transformer)
